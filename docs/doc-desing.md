...
* *As Alex,* I want to paste screenshots directly into comments so I can report visual bugs much faster.
* *As Alex,* I want to copy the direct Taiga link of an issue with one click to share it with my team.

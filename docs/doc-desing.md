...
- **Dashboard & Filtering:**
  - _As Alex,_ I want to filter issues by inclusion/exclusion logic and have the app remember my "Triage View" defaults.
  - **Acceptance Criteria:**
...
- **Issue Management:**
  ...
  - _As Alex,_ if a collision occurs, I want to see exactly what changed on the server vs. my local draft and choose which changes to keep.
